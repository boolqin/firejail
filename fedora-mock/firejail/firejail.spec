...
Provides: firejail
Source0: %{url}/archive/%{version}/%{name}-%{version}.4.tar.gz

Patch0001: https://raw.githubusercontent.com/boolqin/firejail/feat-home-pulse-client-conf-d/patches/0001-feat-pulse-also-create-client.conf.d-folder.patch
